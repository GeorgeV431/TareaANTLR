...
public class ParserParser extends Parser {
	...
	public static final int
		INICIO=1, ENTERO=2, FLOTANTE=3, BOOL=4, CHAR=5, TRUE=6, FALSE=7, PRINTLN=8, 
		LEER=9, IF=10, ELSE=11, FOR=12, WHILE=13, SUMAR=14, RESTAR=15, MULTIPLICAR=16, 
		DIVIDIR=17, RESTO=18, AND=19, OR=20, NOT=21, ES=22, MAYOR=23, MENOR=24, 
		IGUAL=25, NOIGUAL=26, MAYORAL=27, MENORAL=28, SC=29, PAR_A=30, PAR_C=31, 
		LLAV_A=32, LLAV_C=33, COM=34, COMA=35, NUM=36, ID=37, IDS=38, WS=39, COMENTARIOS=40;
	public static final int
	...
	private static final String[] _LITERAL_NAMES = {
		null, "'asamblea'", "'num'", "'dec'", "'funa'", "'letra'", "'funado'", 
		"'desfunado'", "'incel'", "'aliade'", "'cuestionar'", "'noCuestionar'", 
		"'normalizar'", "'romantizar'", "'+'", "'-'", "'*'", "'/'", "'%'", "'&&'", 
		"'||'", "'!'", "'='", "'>'", "'<'", "'=='", "'!='", "'>='", "'<='", "';'", 
		"'('", "')'", "'{'", "'}'", "'\"'", "','"
	};
	private static final String[] _SYMBOLIC_NAMES = {
		null, "INICIO", "ENTERO", "FLOTANTE", "BOOL", "CHAR", "TRUE", "FALSE", 
		"PRINTLN", "LEER", "IF", "ELSE", "FOR", "WHILE", "SUMAR", "RESTAR", "MULTIPLICAR", 
		"DIVIDIR", "RESTO", "AND", "OR", "NOT", "ES", "MAYOR", "MENOR", "IGUAL", 
		"NOIGUAL", "MAYORAL", "MENORAL", "SC", "PAR_A", "PAR_C", "LLAV_A", "LLAV_C", 
		"COM", "COMA", "NUM", "ID", "IDS", "WS", "COMENTARIOS"
	};
	...
	public static class ProgramContext extends ParserRuleContext {
		public TerminalNode INICIO() { return getToken(ParserParser.INICIO, 0); }
		public TerminalNode LLAV_A() { return getToken(ParserParser.LLAV_A, 0); }
		public TerminalNode LLAV_C() { return getToken(ParserParser.LLAV_C, 0); }
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ENTERO) | (1L << FLOTANTE) | (1L << BOOL) | (1L << CHAR) | (1L << TRUE) | (1L << FALSE) | (1L << PRINTLN) | (1L << LEER) | (1L << IF) | (1L << FOR) | (1L << WHILE) | (1L << SUMAR) | (1L << RESTAR) | (1L << MULTIPLICAR) | (1L << DIVIDIR) | (1L << RESTO) | (1L << NUM) | (1L << ID) | (1L << COMENTARIOS))) != 0)) {
				{
				{
				setState(42);
				sentencias();
	...
	public static class SentenciasContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitSentencias(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ComentarioContext extends ParserRuleContext {
		public TerminalNode COMENTARIOS() { return getToken(ParserParser.COMENTARIOS, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitComentario(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DeclaracionContext extends ParserRuleContext {
		...
		public TerminalNode ES() { return getToken(ParserParser.ES, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitDeclaracion(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AsignacionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitAsignacion(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LeerContext extends ParserRuleContext {
		public TerminalNode LEER() { return getToken(ParserParser.LEER, 0); }
		public TerminalNode PAR_A() { return getToken(ParserParser.PAR_A, 0); }
		public NombreContext nombre() {
			return getRuleContext(NombreContext.class,0);
		}
		public TerminalNode PAR_C() { return getToken(ParserParser.PAR_C, 0); }
	...
	public static class ImprimirContext extends ParserRuleContext {
		...
		public TerminalNode COMA() { return getToken(ParserParser.COMA, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitImprimir(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class OperacionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitOperacion(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ReformularContext extends ParserRuleContext {
		public TerminalNode SUMAR() { return getToken(ParserParser.SUMAR, 0); }
		public TerminalNode RESTAR() { return getToken(ParserParser.RESTAR, 0); }
		public TerminalNode DIVIDIR() { return getToken(ParserParser.DIVIDIR, 0); }
		public TerminalNode MULTIPLICAR() { return getToken(ParserParser.MULTIPLICAR, 0); }
		public TerminalNode RESTO() { return getToken(ParserParser.RESTO, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitReformular(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PreguntaContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitPregunta(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SinElseContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitSinElse(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ComparacionContext extends ParserRuleContext {
		public TerminalNode IGUAL() { return getToken(ParserParser.IGUAL, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitComparacion(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IteracionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitIteracion(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Iter_whileContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitIter_while(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Iter_forContext extends ParserRuleContext {
		...
		public TerminalNode ES() { return getToken(ParserParser.ES, 0); }
		public TerminalNode NUM() { return getToken(ParserParser.NUM, 0); }
		public List<TerminalNode> SC() { return getTokens(ParserParser.SC); }
		public TerminalNode SC(int i) {
			return getToken(ParserParser.SC, i);
		}
		public CondicionContext condicion() {
			return getRuleContext(CondicionContext.class,0);
		}
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitIter_for(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CondicionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitCondicion(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class RecorrerContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitRecorrer(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Tipo_datoContext extends ParserRuleContext {
		...
		public TerminalNode FLOTANTE() { return getToken(ParserParser.FLOTANTE, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ParserVisitor ) return ((ParserVisitor<? extends T>)visitor).visitTipo_dato(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ValorContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof